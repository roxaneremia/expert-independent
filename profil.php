...
<table id="tabel_joburi" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th style="text-align:center">Nominalizare castigator</th>
            </tr>
        </thead>
        <!--<tfoot>
            <tr>
...
<?php
    ...
    $query = "SELECT * FROM  postare_serviciu 
              WHERE postare_serviciu.id_membru LIKE '%".$_SESSION["id_membru"]."%'
          ...
          { $c++;?>
                 ...
                 <tr>
                    ...
                    <td style="text-align:center"><?php 
                     ...
                     ?></td>
                     <td style="text-align:center"><a class="fancybox fancybox.iframe" href="nominalizare-job.php?id_job=<?php echo $row["id_serviciu"]; ?>">[nominalizare]</a></td>
                 </tr> 
