...
<div class="container" style="margin-top: 3%">
  ...
  <button style="float:right" type="submit" onclick="window.open('ofertare.php?id_job=<?php echo $_GET['id_job']; ?>&titlu=<?php echo $_GET['titlu']?>','_self')" class="btn btn-primary btn-lg" name="inscriere">Inscrie-te in concurs</button>
