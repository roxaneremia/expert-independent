    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav">
          <li><a href="<?php echo URL; ?>/">Cauta un serviciu</a></li>
          <?php if(isset($_SESSION['nume_cont'])) { ?>
             <li><a href="<?php echo URL; ?>/posteaza-job.php">Posteaza un serviciu</a></li>
          <?php } else { ?>
             <li><a href="<?php echo URL; ?>/posteaza-job.php?u=posteaza-job">Posteaza un serviciu</a></li>
          <?php }  ?>
